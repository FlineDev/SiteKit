document.addEventListener('DOMContentLoaded', function () {
   ...
   if (searchBtn) {
         ...
         searchOverlay.innerHTML =
            '<div class="sk-search-modal">' +
               '<div class="sk-search-header">' +
                  ...
                  '<input class="sk-search-input" type="text" placeholder="Search episodes, tags\u2026" autocomplete="off"/>' +
      ...
      function renderInstantResults(container, query) {
         ...
         // Match episodes by title + summary
         ...
         if (matched.length > 0) {
            html += '<div class="sk-search-section">EPISODES</div>';
